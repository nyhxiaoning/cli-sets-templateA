enum cliTypes {
    "v3ts" = "default-vue3-vite-ts-eslint-babel",
    "v3tswebpack" = "vue3-webpack-ts-eslint-babel-prettier-autoformat",
    "v3nots" = "vue3-nots-vite-eslint-babel",
