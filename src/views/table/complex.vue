<template>
  <div style="padding:20px">
    <vxe-table
      border highlight-hover-row resizable height="400" :tooltip-config="{}" :menu-config="{}"
      :data="tableData" @header-cell-click="headerCellClickEvent" @header-cell-dblclick="headerCellDblclickEvent"
      @header-cell-menu="headerCellContextMenuEvent" @cell-click="cellClickEvent"
      @cell-dblclick="cellDBLClickEvent" @cell-mouseenter="cellMouseenterEvent"
      @cell-mouseleave="cellMouseleaveEvent" @cell-menu="cellContextMenuEvent"
      @footer-cell-click="footerCellClickEvent" @footer-cell-dblclick="footerCellDblclickEvent"
      @footer-cell-menu="footerCellContextMenuEvent" @scroll="scrollEvent"
    >
      <vxe-column type="seq" title="序号" width="60" fixed="left" />
      <vxe-column field="name" title="Name" width="300" />
      <vxe-colgroup title="Role" width="300">
        <vxe-column field="role" title="Role" width="300" />
      </vxe-colgroup>
      <vxe-column field="sex" title="Sex" width="300" />
      <vxe-column field="date" title="Date" width="300" />
      <vxe-column field="address" title="Address" fixed="right" width="300" />
    </vxe-table>
    ...
    <div style="text-align:center;padding:20px">
      详细说明：<a
        href="https://xuliangzhan_admin.gitee.io/vxe-table/v4/table/advanced/event" target="_blank"
